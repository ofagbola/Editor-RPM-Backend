...
export interface SubscriptionServiceClient extends grpc.Client {
  ...
  DeleteSubscription(argument: _scheduler_DeleteSubscription, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
  DeleteSubscription(argument: _scheduler_DeleteSubscription, metadata: grpc.Metadata, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
  DeleteSubscription(argument: _scheduler_DeleteSubscription, options: grpc.CallOptions, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
  DeleteSubscription(argument: _scheduler_DeleteSubscription, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
  deleteSubscription(argument: _scheduler_DeleteSubscription, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
  deleteSubscription(argument: _scheduler_DeleteSubscription, metadata: grpc.Metadata, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
  deleteSubscription(argument: _scheduler_DeleteSubscription, options: grpc.CallOptions, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
  deleteSubscription(argument: _scheduler_DeleteSubscription, callback: grpc.requestCallback<_scheduler_SubscriptionMessage__Output>): grpc.ClientUnaryCall;
...
export interface SubscriptionServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  DeleteSubscription: grpc.handleUnaryCall<_scheduler_DeleteSubscription__Output, _scheduler_SubscriptionMessage>;
...
export interface SubscriptionServiceDefinition extends grpc.ServiceDefinition {
  ...
  DeleteSubscription: MethodDefinition<_scheduler_DeleteSubscription, _scheduler_SubscriptionMessage, _scheduler_DeleteSubscription__Output, _scheduler_SubscriptionMessage__Output>

...
import (
	...
	_ "github.com/ofagbola/Editor-RPM-Backend/scheduler/doc/statik"
	"github.com/ofagbola/Editor-RPM-Backend/scheduler/gapi"
...
func runGatewayServer(config util.Config, store db.Store) {
	...
	err = pb.RegisterSchedulerServiceHandlerServer(ctx, grpcMux, server)
	if err != nil {
